...
| 字数范围 | 建议集数 | 说明 |
|---------|---------|------|
| < 5万字 | 20-30集 | 内容较少,需精简表达 |
| 5-15万字 | 50-80集 | 标准长度,适合漫剧 |
| 15-30万字 | 80-120集 | 需精简主线,删减支线 |
| 30-50万字 | 100-150集 | 只改编核心情节 |
| > 50万字 | 建议只改编主线 | 或分季制作 |
...
- 1-2分钟/集,快节奏
- 适合题材: [根据题材评估结果给出建议]
- 下一步: 运行 /select-novel 检查漫剧适配度
- 然后: 运行 /adapt-comic 直接生成漫剧剧本
...
如果选择漫剧:
```
太好了!这部小说{适合/不太适合}改编为漫剧。

建议流程:
1. 运行 /select-novel 进行漫剧选题检查
2. 通过检查后,运行 /adapt-comic --style [风格] --episodes [集数]
3. 生成后运行 /quality-check-comic 检查质量

要现在开始检查吗? (运行 /select-novel)
```
